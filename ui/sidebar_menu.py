...
from dev_tools.operators.object.beamng.beamng_convert_jbeam_to_mesh import OBJECT_OT_BeamngConvertJbeamToMesh # type: ignore
...
class OBJECT_PT_devtools_addon_panel(bpy.types.Panel):
    ...
    def draw_expanded_beamng_options(self, context, layout):
        ...
        if context.scene.expanded_beamng_options:
            ...
            col.operator(OBJECT_OT_BeamngConvertJbeamToMesh.bl_idname, text="Jbeam to Mesh")
            col.separator()
